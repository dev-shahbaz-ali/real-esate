  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-center shrink-0">
        ...
        <button onClick={() => console.log('Add New Deal button clicked')} className="bg-[#0f3b9e] text-white px-5 py-2.5 rounded-lg flex items-center gap-2 font-medium text-sm shadow-sm hover:bg-blue-800 transition">
        ...
        <div className="flex-[2.3] bg-white rounded-xl p-6 shadow-sm border border-slate-200">
          ...
          <div className="grid grid-cols-4 gap-5">
            <PipelineColumn title="New Leads (8)" amount="$3.2M">
              ...
              <button onClick={() => console.log('View all 8 leads button clicked')} className="w-full text-center text-blue-600 text-xs font-medium mt-2 hover:underline py-2">View all 8 leads</button>
            </PipelineColumn>
            <PipelineColumn title="Qualified (7)" amount="$6.5M">
              ...
              <button onClick={() => console.log('View all 7 deals button clicked')} className="w-full text-center text-blue-600 text-xs font-medium mt-2 hover:underline py-2">View all 7 deals</button>
            </PipelineColumn>
            <PipelineColumn title="In Negotiation (5)" amount="$8.1M">
              ...
              <button onClick={() => console.log('View all 5 deals button clicked')} className="w-full text-center text-blue-600 text-xs font-medium mt-2 hover:underline py-2">View all 5 deals</button>
            </PipelineColumn>
            <PipelineColumn title="Closed Won (8)" amount="$6.8M">
              ...
              <button onClick={() => console.log('View all 8 deals button clicked')} className="w-full text-center text-blue-600 text-xs font-medium mt-2 hover:underline py-2">View all 8 deals</button>
            </PipelineColumn>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-6 max-w-[360px]">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
            ...
            <div className="space-y-3">
              ...
              <TaskItem text="Prepare CMA for 789 Park Ave" time="Tomorrow, 9:00 AM" /> {/* This button needs an onClick */}
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => console.log('View all Upcoming Showings button clicked')} className="text-blue-600 text-xs font-medium">View all</button>
            </div>
